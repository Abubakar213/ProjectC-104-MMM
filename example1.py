...
def findMean(total_sum,total_entries):
    mean = total_sum/total_entries
    print(mean)

def findMedian(total_entries,sorted_data):
...
findMean(total_weight, total_entries)
findMedian(total_entries, sorted_data)
findMode(sorted_data)
